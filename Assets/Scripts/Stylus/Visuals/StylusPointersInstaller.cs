...
public class StylusPointersInstaller : MonoBehaviour {
    [SerializeField] private StylusPointerVisualChanger visualPack;
    ...
    private void AddVisualPackStylus(Stylus stylus) {
        ...
        instanceVisualPack.GetComponent<StylusPointerVisualChanger>().SetStylus(stylus);
